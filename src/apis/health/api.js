...
var HealthAPI = /** @class */ (function (_super) {
     ...
     */
    function HealthAPI(core, baseURL) {
        if (baseURL === void 0) { baseURL = "/ext/health"; }
        var _this = _super.call(this, core, baseURL) || this;
        /**
         *
         * @returns Promise for a [[HealthResponse]]
         */
        _this.health = function () { return __awaiter(_this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.callMethod("health.health")];
                    case 1:
                        response = _a.sent();
