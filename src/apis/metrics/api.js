...
var restapi_1 = require("../../common/restapi");
/**
...
var MetricsAPI = /** @class */ (function (_super) {
     ...
     */
    function MetricsAPI(core, baseURL) {
        if (baseURL === void 0) { baseURL = "/ext/metrics"; }
        var _this = _super.call(this, core, baseURL) || this;
        _this.axConf = function () {
            return {
                baseURL: "".concat(_this.core.getProtocol(), "://").concat(_this.core.getHost(), ":").concat(_this.core.getPort()),
                responseType: "text"
            };
        };
        /**
         ...
         */
        _this.getMetrics = function () { return __awaiter(_this, void 0, void 0, function () {
            var response;
