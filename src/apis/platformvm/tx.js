...
var addsubnetvalidatortx_1 = require("./addsubnetvalidatortx");
/**
 * @ignore
 */
...
var SelectTxClass = function (txtype) {
    ...
    if (txtype === constants_1.PlatformVMConstants.BASETX) {
        ...
        return new (validationtx_1.AddDelegatorTx.bind.apply(validationtx_1.AddDelegatorTx, __spreadArray([void 0], args, false)))();
    }
    else if (txtype === constants_1.PlatformVMConstants.ADDVALIDATORTX) {
        return new (validationtx_1.AddValidatorTx.bind.apply(validationtx_1.AddValidatorTx, __spreadArray([void 0], args, false)))();
    }
    else if (txtype === constants_1.PlatformVMConstants.CREATESUBNETTX) {
        return new (createsubnettx_1.CreateSubnetTx.bind.apply(createsubnettx_1.CreateSubnetTx, __spreadArray([void 0], args, false)))();
    }
    else if (txtype === constants_1.PlatformVMConstants.ADDSUBNETVALIDATORTX) {
        return new (addsubnetvalidatortx_1.AddSubnetValidatorTx.bind.apply(addsubnetvalidatortx_1.AddSubnetValidatorTx, __spreadArray([void 0], args, false)))();
    }
