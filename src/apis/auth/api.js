...
var AuthAPI = /** @class */ (function (_super) {
     ...
     */
    function AuthAPI(core, baseURL) {
        if (baseURL === void 0) { baseURL = "/ext/auth"; }
         ...
         */
        _this.newToken = function (password, endpoints) { return __awaiter(_this, void 0, void 0, function () {
            var params, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.callMethod("auth.newToken", params)];
                    case 1:
                        response = _a.sent();
         ...
         */
        _this.revokeToken = function (password, token) { return __awaiter(_this, void 0, void 0, function () {
            var params, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.callMethod("auth.revokeToken", params)];
                    case 1:
                        response = _a.sent();
         ...
         */
        _this.changePassword = function (oldPassword, newPassword) { return __awaiter(_this, void 0, void 0, function () {
            var params, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.callMethod("auth.changePassword", params)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data.result.success];
                }
