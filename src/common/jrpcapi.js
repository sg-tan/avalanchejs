...
var JRPCAPI = /** @class */ (function (_super) {
    __extends(JRPCAPI, _super);
    /**
     *
     ...
     */
    function JRPCAPI(core, baseURL, jrpcVersion) {
        if (jrpcVersion === void 0) { jrpcVersion = "2.0"; }
        var _this = _super.call(this, core, baseURL) || this;
        _this.jrpcVersion = "2.0";
        _this.rpcID = 1;
        _this.callMethod = function (method, params, baseURL, headers) { return __awaiter(_this, void 0, void 0, function () {
            var ep, rpc, headrs, axConf, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headrs = { "Content-Type": "application/json;charset=UTF-8" };
                        if (headers) {
                            headrs = __assign(__assign({}, headrs), headers);
                        }
                        ...
                        return [4 /*yield*/, this.core.post(ep, {}, JSON.stringify(rpc), headrs, axConf)];
                    case 1:
                        resp = _a.sent();
         ...
         */
        _this.getRPCID = function () { return _this.rpcID; };
        _this.jrpcVersion = jrpcVersion;
        _this.rpcID = 1;
        return _this;
    }
    return JRPCAPI;
